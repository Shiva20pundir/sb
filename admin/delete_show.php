...
require_once '../config/dbConfig.php';
  	...
  	$data_query = "SELECT movie_id, movie_poster, movie_name, release_date, movie_language, movie_duration FROM tbl_movie";
			  ...
			  echo "<ul class='show-board'>";
			    while ($detail = mysqli_fetch_assoc($result)) {
				    ...
				    echo "<strong class='show-movie'>".$m_dta['movie_name']."</strong>
						  <a href='delete_show.inc.php?show=".$detail['show_id']."'>&#10060;</a>
				          </li>";
				}
			  echo "</ul>";
			}
...
<div class="right">
	...
	<?php 
    $query = "SELECT show_date FROM tbl_movieshow ORDER BY show_date DESC";
	$result = mysqli_query($dbConn, $query);
